  ...
  while ( have_posts() ) :
    ...
    <div class="container">
      <div class="row border-top row-column-border row-column-menu-left border-light">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div id="collapse-one" class="accordion-collapse collapse show" role="region" aria-labelledby="accordion-title-one">
                                            <div class="accordion-body">
                                                ...
                                                <li class="nav-item">
                                                <a class="nav-link" href="#patrocinio-sponsor">
                                                <span class="title-medium">Patrocinato da</span>
                                                </a>
                                                </li>
                                                <?php } ?>
                                                <?php if (  $more_info ) {  ?>
        ...
        <section class="col-lg-8 it-page-sections-container border-light">
          ...
          <article id="luogo" class="it-page-section mb-5">
            <h2 class="mb-3">Luogo dell'evento</h2>
            <?php
                $luogo = $luogo_evento;
          ...
          <article id="date-e-orari" class="it-page-section mb-5">
              ...
              $luogo = (@$luogo_evento ? $luogo_evento->post_title : '');
              ?>
              <div class="mt-5">
          ...
          <article id="costi" class="it-page-section mb-5">
              ...
              <div class="card no-after border-start mt-3">
                  <div class="card-body">
                      <p class="h5"><?php echo @$costo['titolo_costo']; ?></p>
                      <p class="h5"><?php echo @$costo['prezzo_costo']; ?></p>
                      <p class="mt-4">
          ...
          <?php if( is_array($organizzatori) && count($organizzatori) ) { ?>
            <h3 class="h5 mt-5">Con il supporto di:</h3>
	    <div class="row mt-3">
            <?php foreach ($organizzatori as $uo_id) { ?>
		<div class="col-lg-<?php print( count($organizzatori)>1 ? '6' : '12' ); ?>">
	  ...
	  <?php } ?>
          ...
          <article id="patrocinio-sponsor" class="it-page-section mt-5 mb-5">
          <?php 
         if ( (is_array($patrocinato) && count($patrocinato)) || 
          (is_array($sponsor) && count($sponsor)))  {
              if ( is_array($patrocinato) && count($patrocinato) ) {
                  echo '<h3>Patrocinato da</h3>';
