    ...
    <div class="row justify-content-center">
        ...
        <div class="cmp-hero">
            ...
            <div class="it-hero-text-wrapper pt-0 ps-0 pb-40">
                ...
                L'appuntamento è prenotato per <strong id="date-recap"></strong>
                <br /><br />Abbiamo inviato il riepilogo all’email:<br />
                <strong id="email-recap"></strong>
                </p>
<?php /*
                <p class="titillium hero-text mt-3">
		<strong>NOTA:<br />
		Questa è solo la prenotazione della vostra richiesta. L'appuntamento vi verrà definitivamente confermato dai nostri uffici tramite le informazioni contatto che avete indicato.
		</strong></p>
*/ ?>
            </div>
            </section>
