          ...
          <div class="card w-100">
            <div class="card-body">
              ...
              <ul class="contact-list p-0">
                ...
                <li>
                  <a class="list-item" href="/servizi/assistenza" data-element="contacts"
                ...
                <li>
                  ...
                  <svg class="icon icon-primary icon-sm" aria-hidden="true">
                      <use
                        href="#it-hearing"
                      ></use></svg><span>Chiama il Comune <?php echo $numero_verde; ?></span></a
                  >
                </li>
                <li>
              ...
              <ul class="contact-list p-0">
                <li>
                  <a class="list-item" href="mailto:postacertificata@pec.comune.lavagna.ge.it"
                    ><svg class="icon icon-primary icon-sm" aria-hidden="true">
                      <use
