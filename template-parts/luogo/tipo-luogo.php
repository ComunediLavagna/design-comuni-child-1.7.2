 ...
 * STS 2023
 */
global $obj, $tipo_luogo, $with_border, $uo_id, $custom_class;
            ...
            <div class="it-hero-card it-hero-bottom-overlapping rounded hero-p pb-lg-80 drop-shadow <?php echo ($img? '' : 'mt-0'); ?>">
                ...
                <div class="row sport-wrapper justify-content-between mt-lg-2">
                  <div class="col-12 col-lg-5 offset-lg-1">
                    ...
                    <h2 class="visually-hidden" id="news-details">Dettagli del tipo di luogo</h2>
                    <p class="u-main-black text-paragraph-regular-medium mb-60">
                        <?php echo $tipo_luogo->description; ?>
                    </p>
                  </div>
                </div>
...
<?php 
    $posts = dci_get_grouped_posts_by_term( 'luogo' , 'tipi_luogo', $tipo_luogo->slug, -1 ); // -1 = all
?>

<section id="lista-luoghi">
    <div class="bg-grey-card pt-40 pt-md-100 pb-50">
		...
		?>
            ...
            <div class="d-flex justify-content-end mt-5 me-5">
                <a href="/luoghi/" class="btn btn-outline-primary full-mb">
                    Tutti i luoghi 
