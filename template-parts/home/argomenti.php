<?php
global $has_argomenti_evidenza, $into_argomento, $argomento_full, $count;
...
<div class="container">
    ...
    <div>
		...
		$into_argomento = false;
            }?>
        </div>
    </div>
    <?php } 
    if ($altri_argomenti) { ?>
    <div class="row pt-30 <?php print($has_argomenti_evidenza?'':'pb-80'); ?>">
        <div class="col-lg-10 col-xl-6 offset-lg-1 offset-xl-3">
            <div class="row d-lg-inline-flex">
                <div class="col-lg-3">
                    <h3 class="text-uppercase mb-3 title-xsmall-bold text <?php print($has_argomenti_evidenza?'':'text-white'); ?>">
                        Altri argomenti
                    </h3>
                </div>
                <div class="col-lg-9">
        ...
        <div class="col-lg-10 col-xl-8 offset-lg-1 offset-xl-2 text-center">
            <a role="button" href="<?php echo dci_get_template_page_url("page-templates/argomenti.php"); ?>" class="btn btn-outline-<?php print($has_argomenti_evidenza?'primary':'light'); ?> mt-40 d-inline-block read-more">
		Mostra tutti
		    <svg class="icon">
