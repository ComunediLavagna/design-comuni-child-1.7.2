...
<section id="notizie" aria-describedby="novita-in-evidenza">
    <div class="section-content px-lg-5">
        <div class="container">
            <h2 id="novita-in-evidenza" class="visually-hidden">Novit&agrave; in evidenza</h2>
            <?php if ($post_id) {
            ...
            ?>
                <div class="row">
                    ...
                    <div class="col-lg-6 offset-lg-1 order-1 order-lg-2 px-0 px-lg-2">
                        <?php if ($img) {
                            sts_get_img_by_id( attachment_url_to_postid( $img ), 'img-fluid', '', '', '', false /* not lazy */ );  /* dci_get_img($img, 'img-fluid'); */
                        } ?>
                    </div>
                </div>
            ...
            if ($posts && is_array($posts) && count($posts) > 0) { ?>
                ...
                <div class="my-5 justify-content-md-center">
                    <a role="button" class="btn btn-outline-primary d-inline-block read-more pb-3" href="<?php echo dci_get_template_page_url("page-templates/novita.php"); ?>">
                        Tutte le novità
                            <svg class="icon">
