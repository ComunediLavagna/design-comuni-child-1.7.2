    ...
    <main>
        ...
        while ( have_posts() ) :
            ...
            $condizioni_servizio = dci_get_meta("condizioni_servizio");     
             $punti_contatto = dci_get_meta("punti_contatto"); // Contatti
	    ...
	    $documenti = dci_get_meta("documenti");
            ...
            <script type="application/ld+json" data-element="metatag">{
                    "name": "<?php echo convertToPlain($post->post_title); ?>",
		"serviceType": "<?php print( convertToPlain( !empty($categoria_servizio) ? $categoria_servizio : 'Servizio' ) ); ?>",
                    "serviceOperator": {
 		   "name": "<?php print( convertToPlain( !empty($ipa) ? $ipa : 'Comune' ) ); ?>"
                   },
                    "areaServed": {
                        "name": "Comune"
                    },
                    "audience": {
		   "audienceType": "Cittadini"
                    },
                    "availableChannel": {
		   "serviceUrl": "<?php print( convertToPlain( !empty($canale_digitale_link) ? $canale_digitale_link : '#' ) ); ?>",
                         "serviceLocation": {
			"name": "<?php print( convertToPlain( !empty($ufficio) ? $ufficio->post_title : 'Sede del Comune' ) ); ?>",
                           "address": {
                                "streetAddress": "<?php print( convertToPlain( !empty($indirizzo) ? $indirizzo : '#' ) ); ?>",
                                "postalCode": "<?php print( convertToPlain( !empty($cap) ? $cap : '#' ) ); ?>",
                                "addressLocality": "<?php print( convertToPlain( !empty($quartiere) ? $quartiere : '#' ) ); ?>"
                            }
                        }
                    }
            }</script>
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <p class="subtitle-small mb-3" data-element="service-description">
                                        <?php if ($descrizione_breve) { print($descrizione_breve); } else { print( '<span class="d-none">Descrizione del servizio</span>' ); } ?>
                                    </p>
            ...
            <div class="container">
			    ...
			    <nav class="navbar it-navscroll-wrapper navbar-expand-lg" aria-label="Indice della pagina" data-bs-navscroll>
                                                    ...
                                                    <div id="collapse-one" class="accordion-collapse collapse show" role="region" aria-labelledby="accordion-title-one">
                                                        <div class="accordion-body">
                                                            <ul class="link-list" data-element="page-index">
                                                                <li class="nav-item <?php if (!$descrizione) { print( 'd-none' ); } ?>">
                                                                    <a class="nav-link" href="#description">
                                                                        <span class="title-medium">Descrizione</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item <?php if (!$destinatari) { print( 'd-none' ); } ?>">
                                                                    <a class="nav-link" href="#who-needs">
                                                                        <span class="title-medium">A chi è rivolto</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item <?php if (!$come_fare) { print( 'd-none' ); } ?>">
                                                                    <a class="nav-link" href="#how-to">
                                                                        <span class="title-medium">Come fare</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item <?php if (!($cosa_serve_intro or (is_array($cosa_serve_list) && count($cosa_serve_list)>0))) { print( 'd-none' ); } ?>">
                                                                    <a class="nav-link" href="#needed">
                                                                        <span class="title-medium">Cosa serve</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item <?php if (!$output) { print( 'd-none' ); } ?>">
                                                                    <a class="nav-link" href="#obtain">
                                                                        <span class="title-medium">Cosa si ottiene</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item <?php if (!( !empty($fasi_scadenze_intro) || (is_array($fasi_scadenze) && count($fasi_scadenze)) || (is_array($fasi_group_simple_scadenze) && count($fasi_group_simple_scadenze)) )) { print( 'd-none' ); } ?>">
                                                                    <a class="nav-link" href="#deadlines">
                                                                        <span class="title-medium">Tempi e scadenze</span>
                                                                    </a>
                                                                </li>
                                                                <li class="nav-item <?php if (!$costi) { print( 'd-none' ); } ?>">
                                                                ...
                                                                <li class="nav-item <?php if (!$condizioni_servizio) { print( 'd-none' ); } ?>">
                    ...
                    <div class="col-12 col-lg-8 offset-lg-1">
                        <div class="it-page-sections-container">
                            ...
                            <section class="it-page-section mb-30 <?php if (!$descrizione) { print( 'd-none' ); } ?>">
                            ...
                            <section class="it-page-section mb-30 <?php if (!$destinatari) { print( 'd-none' ); } ?>">
                            ...
                            <section class="it-page-section mb-30 <?php if (!$come_fare) { print( 'd-none' ); } ?>">
                            ...
                            <section class="it-page-section mb-30 has-bg-grey p-3 <?php if (!($cosa_serve_intro or (is_array($cosa_serve_list) && count($cosa_serve_list)>0))) { print( 'd-none' ); } ?>">
                                ...
                                <div class="richtext-wrapper lora" data-element="service-needed">
                                    ...
                                    <ul >
                                        <?php if (is_array($cosa_serve_list)) { foreach ($cosa_serve_list as $cosa_serve_item) { ?>
                            ...
                            <section class="it-page-section mb-30 <?php if (!$output) { print( 'd-none' ); } ?>">
				...
				<?php echo $output ?>
                            ...
                            <section class="it-page-section mb-30 <?php if (!( !empty($fasi_scadenze_intro) || (is_array($fasi_scadenze) && count($fasi_scadenze)) || (is_array($fasi_group_simple_scadenze) && count($fasi_group_simple_scadenze)) )) { print( 'd-none' ); } ?>">
                            ...
                            <section class="it-page-section mb-30 <?php if (!$costi) { print( 'd-none' ); } ?>">
                            ...
                            <section class="it-page-section mb-30 pb-5 has-bg-grey p-4">
                                <h2 class="mb-3" id="submit-request">Accedi al servizio</h2>
                                <?php if ($canale_digitale_link) { ?>
                                <p class="text-paragraph lora mt-3" data-element="service-generic-access"><?php echo $canale_digitale_text; ?></p>
                                <button type="button" class="btn btn-primary mobile-full mb-2" onclick="location.href='<?php echo $canale_digitale_link; ?>';" data-element="service-online-access">
                                    <span class=""><?php echo $canale_digitale_label; ?></span>
                                </button>
                                <?php } ?>
				<?php if ($canale_fisico_text) { ?>
                                <p class="text-paragraph lora mt-3" data-element="service-generic-access"><?php echo $canale_fisico_text; ?></p>
                                <button type="button" class="btn btn-outline-primary t-primary bg-white mobile-full mb-2" onclick="location.href='<?php echo dci_get_template_page_url('page-templates/prenota-appuntamento.php'); ?>';" data-element="service-booking-access">
                                    <span class="">Prenota appuntamento</span>
                                </button>
				<?php } ?>
                            </section>
			    
                            <?php if ( $condizioni_servizio ) { $file_url = $condizioni_servizio; } ?>
                            <section class="it-page-section mb-30 <?php if (!$condizioni_servizio) { print( 'd-none' ); } ?>">
			...
			<?php if( is_array($documenti) && count($documenti) ) { ?>
			    ...
			    <h2 class="mb-3" id="documents">Documenti</h2>
                                <div class="row">
			...
			<?php } ?>
			    ...
			    <div class="row">
			     <?php if ( is_array($punti_contatto) && count($punti_contatto) ) { ?>
					...
					<div class="<?php print( count($punti_contatto)>1 ? 'col-lg-6' : 'col-lg-12 col-md-8 col-lg-6' ); ?> mb-30">
				...
				<a href="#footer-contacts" class="chip chip-simple" data-element="service-area" data-focus-mouse="false">
					<span class="chip-label">Informazioni di contatto del Comune</span>
				    </a>
				<div>
				<div>
			    <?php } ?>
			...
			<?php /* } */ ?>
                             <?php if ( $uo_id ) { ?>
                              <section class="it-page-section">
			    <h2 class="mb-3" id="organization">Unità Organizzativa Responsabile</h2>
                                <div class="row">
                                    <div class="col-12 col-md-8 col-lg-6 mb-30">
                                        <div class="card-wrapper rounded h-auto mt-10">
                                            <?php
			...
			<?php } ?>
			   ...
			   <div class="row">
                                    <div class="col-12 mb-30">
				    <?php if (is_array($argomenti) and count($argomenti)>0) { ?>
				   ...
				   <div class="mb-30">
					...
					<ul class="d-flex flex-wrap gap-2 mt-10 mb-30">
						<li>
						    <a href="/argomenti" class="chip chip-simple" data-element="service-topic">
							<span class="chip-label">
							    Tutti gli argomenti
							</span>
						    </a>
