...
?>
    ...
    <main>
        ...
        while ( have_posts() ) :
            ...
            $data_inizio = dci_get_meta("data_inizio", $prefix, $post->ID);
            $data_fine = dci_get_meta("data_fine", $prefix, $post->ID);
            ?>
            <div class="container" id="main-container">
                ...
                <div class="row">
                    <div class="col-lg-8 px-lg-4 py-lg-2">
                        <h1><?php the_title(); ?></h1>
                        <h2 class="visually-hidden">Documento pubblico</h2>
                        <p>
            ...
            <div class="container">
                                ...
                                <table>
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="ps-2">                                
                                                <?php foreach($tipo_documento as $tipo) { 
                                                    ...
                                                    ?>
                                                    <a class="" href="<?php echo $url; ?>" aria-label="Vai all'archivio <?php echo esc_attr($tipo->name); ?>" title="Vai all'archivio <?php echo esc_attr($tipo->name); ?>">
                                                        <?php echo ucfirst($tipo->name); ?>
                                                    </a> 
                                                <?php }  ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="ps-2">n. <?php echo $numero_protocollo; ?> del <?php echo $data_protocollo; ?></td>
                                        </tr>
                                        <tr>
                                            <td><b>Data di pubblicazione</b></td>
                                            <td class="ps-2"><?php the_date() ?></td>
                                        </tr>
                                        <tr>
                                            <td><b>Oggetto</b></td>
                                            <td class="ps-2"><?php echo $descrizione_breve; ?></td>
                                        </tr>
                                        <?php if ($autori) { ?>
                                            <tr>
                                                <td><b>Autori</b></td>
                                                <td class="ps-2"><?php echo $autori; ?></td>
                                            </tr>
                                        <?php } ?>
                                        <?php if ($formati) { ?>
                                            <tr>
                                                <td><b>Formati</b></td>
                                                <td class="ps-2"><?php echo $formati; ?></td>
                                            </tr>
                                        <?php } ?>
                                        <?php if ($licenza) { ?>
                                            <tr>
				...
				<?php if ($data_inizio) { ?>
					<tr>
					    <td><b>Data inizio validit??</b></td>
					    <td class="ps-2"><?php print( wp_date( get_option( 'date_format' ), $data_inizio )); ?></td>
					</tr>
				<?php } ?>
				<?php if ($data_fine) { ?>
					<tr>
					    <td><b>Data di scadenza</b></td>
					    <td class="ps-2"><?php print( wp_date( get_option( 'date_format' ), $data_fine )); ?></td>
					</tr>
				<?php } ?>
                    ...
                    <article id="documenti" class="it-page-section anchor-offset mt-5">
                        ...
                        <div class="card-wrapper card-teaser-wrapper card-teaser-wrapper-equal">
                            ...
                            <div class="card card-teaser shadow-sm p-4 mt-3 rounded border border-light flex-nowrap">
                                ...
                                <div class="card-body">
                                <p class="card-title">
                                    <a href="<?php echo $file_documento; ?>" aria-label="Scarica il documento <?php echo $documento->post_title; ?>" title="Scarica il documento <?php echo $documento->post_title; ?>">
                    ...
                    <?php if ($dataset && is_array($dataset) && count($dataset)>0 ) { ?>
                        <article id="dataset" class="it-page-section anchor-offset mt-5">
                            <h3>Dataset</h3>
				<h4 class="visually-hidden">Dataset collegati</h4>
                           <div class="row">
                                <div class="col-12 col-sm-8">
